...
The demo includes convergence, a mathematically impossible deadlock, an adversarial override challenge, two distinct wallet-signed approvals bound to a unique negotiation identity, canonical proof hashing, a downloadable receipt, and public signature-plus-devnet verification at `/verify`.
