...
The demo includes convergence, a mathematically impossible deadlock, an adversarial override challenge, two distinct wallet-signed approvals, proof signing, a downloadable portable receipt, and public signature-plus-devnet verification at `/verify`.
